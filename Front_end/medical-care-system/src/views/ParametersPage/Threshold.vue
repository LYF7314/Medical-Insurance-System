        ...
        <el-card class="box-card">
            ...
            <el-form :inline="true" :model="capLineForm" class="demo-form-inline">
                <el-form-item label="医疗类别">
                    <el-input v-model="capLineForm.medicalType" placeholder="MEDICAL TYPE"></el-input>
                </el-form-item>
                <el-form-item label="医疗人员类别">
                    <el-input v-model="capLineForm.medicalPersonnelType" placeholder="PERSONNEL TYPE"></el-input>
                </el-form-item>
                <el-form-item label="医院等级">
                    <el-input v-model="capLineForm.hospitalLevel" placeholder="LEVEL"></el-input>
                </el-form-item>
                <el-form-item>
